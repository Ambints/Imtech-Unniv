...
async function createSampleDepenses() {
  ...
  try {
    ...
    console.log(`📅 Using annee_academique: ${anneeId}\n`);
    ...
    const depenses = [
      ...
      {
        libelle: 'Achat de livres bibliothèque',
        montant: 450000,
        categorie: 'fonctionnement',
        fournisseur: 'Librairie Universitaire',
        numero_facture: 'FC-2024-005',
        statut: 'en_attente',
        observations: 'Nouveaux ouvrages pour la bibliothèque'
      },
      {
        libelle: 'Réparation climatisation',
        montant: 250000,
        categorie: 'fonctionnement',
        fournisseur: 'Clim Expert',
        numero_facture: 'FC-2024-006',
        statut: 'rejete',
        observations: 'Devis trop élevé'
      }
    ];

    console.log('📝 Creating sample depenses...\n');
    ...
    console.log('✅ Sample depenses created successfully!\n');
