...
export class RHController {
  ...
  @Get('utilisateurs')
  @Roles('rh', 'responsable_rh', 'admin', 'secretaire')
  ...
  @Get('departements')
  @Roles('rh', 'responsable_rh', 'admin', 'secretaire')
  @ApiOperation({ summary: 'Liste des départements du tenant' })
  getDepartements() {
  ...
  // ========== CONTRATS ==========
  @Post('contrats')
  @Roles('rh', 'responsable_rh', 'admin', 'president')
  ...
  @Roles('rh', 'secretaire', 'responsable_rh', 'admin')
  ...
  // ========== CONGÉS ==========
  @Post('conges')
  @Roles('rh', 'utilisateur', 'responsable_rh', 'admin')
  ...
  @Roles('rh', 'responsable_rh', 'admin', 'secretaire', 'utilisateur')
  ...
  // ========== ÉVALUATIONS ==========
  @Post('evaluations')
  @Roles('rh', 'responsable_rh', 'admin', 'superieur')
  ...
  @Roles('rh', 'responsable_rh', 'admin', 'comptable')
