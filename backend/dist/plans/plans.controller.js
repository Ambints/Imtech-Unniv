...
const create_plan_dto_1 = require("../tenants/dto/create-plan.dto");
const update_plan_dto_1 = require("../tenants/dto/update-plan.dto");
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Liste tous les plans d\'abonnement' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Récupère un plan par son ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Plan trouvé' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Crée un nouveau plan d\'abonnement' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Plan créé' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Met à jour un plan d\'abonnement' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Supprime un plan d\'abonnement' }),
