...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Plan de démarrage pour petites universités', required: false }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreatePlanDto.prototype, "maxStudents", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: ['LMS', 'Support Email'], required: false }),
