...
var PresidentDashboardService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PresidentDashboardService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
let PresidentDashboardService = PresidentDashboardService_1 = class PresidentDashboardService {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.logger = new common_1.Logger(PresidentDashboardService_1.name);
    }
    async getKPI(anneeAcademiqueId) {
        const whereAnnee = anneeAcademiqueId ? `WHERE annee_academique_id = '${anneeAcademiqueId}'` : '';
        const [totalEtudiants, etudiantsInscrits, totalEnseignants, totalPersonnel,] = await Promise.all([
    ...
    async getStatsEtudiants(anneeAcademiqueId) {
    ...
    async getStatsFinancieres(anneeAcademiqueId) {
        const anneeFilter = anneeAcademiqueId
    ...
    async getStatsAcademiques(sessionId) {
    ...
    async getRepartitionParParcours(anneeAcademiqueId) {
        const anneeFilter = anneeAcademiqueId
            ? `AND i.annee_academique_id = '${anneeAcademiqueId}'`
            : `AND aa.active = true`;
...
exports.PresidentDashboardService = PresidentDashboardService;
exports.PresidentDashboardService = PresidentDashboardService = PresidentDashboardService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectDataSource)()),
    __metadata("design:paramtypes", [typeorm_2.DataSource])
], PresidentDashboardService);
